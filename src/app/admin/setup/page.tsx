  ...
  return (
    <section className="w-full max-w-md rounded-lg border border-[var(--line)] bg-white p-6 shadow-sm">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-semibold text-[var(--muted)]">Setup closed</p>
          <h1 className="text-2xl font-semibold">Admin already exists</h1>
        </div>
      </div>
      <p className="text-sm leading-6 text-[var(--muted)]">
        This contest already has an administrator. New admin accounts cannot be created.
      </p>
      <Link
